...
= Contributing — jaffascript
:revdate: 2026-MM-DD

== Audience

Developers working *on* `jaffascript`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/jaffascript.git
cd jaffascript
...
* Bugs in `jaffascript`: file at `hyperpolymath/jaffascript/issues`.
